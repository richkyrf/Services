 ...
 * @author JACK
 */
public class JenisService extends javax.swing.JFrame {
    ...
    public JenisService() {
        ...
        setTitle(NamaMaster);
        setVisible(true);
        BTambah.setVisible(hak[16]);
        BUbah.setVisible(hak[17]);
        BHapus.setVisible(hak[18]);
    }

    String NamaMaster = "JENIS SERVICE";
    String SelecQ = " SELECT `No`, `Jenis Service`, `Keterangan` FROM `tjenisservice`";
    String SelecQ2 = "SELECT `No`, `Jenis Service` as '`Jenis Service`', `Keterangan` FROM `tjenisservice`";
    String QInsert;
    String QUpdate;
    String QDelete;

    void GetQinsert() {
        QInsert = "INSERT INTO `tjenisservice`(`Jenis Service`, `Keterangan`) VALUES ('" + JTJenServ.getText() + "','" + JTKet.getText() + "')";
    }

    void GetQupdate() {
        QUpdate = "UPDATE `tjenisservice` SET `Jenis Service`= '" + JTJenServ.getText() + "' ,`Keterangan`='" + JTKet.getText() + "' WHERE `No`='" + JTNO.getText() + "'";
    }

    void getQDelete() {
        QDelete = "DELETE FROM `tjenisservice` WHERE `No`='" + JTNO.getText() + "'";
    }
    ...
    void FCari() {
        ...
        //////system.out.printlnln(SelecQ + " where " + v.get(jcomFromDBtable1.getSelectedIndex()) + " like '%" + JTCari.getText() + "%' order by No Desc");
        jktable1.tampilkan();
    }
    ...
    void getSelectedData() {
        ...
        JTJenServ.setText(jktable1.getstring(bar, 1));
        JTKet.setText(jktable1.getstring(bar, 2));
    }
    ...
    boolean isvalidinput() {
        if (JTJenServ.getText().isEmpty()) {
            showMessageDialog(this, "Jenis Service Tidak Boleh Kosong");
            return false;
        } else {
            return true;
        }
     ...
     */
     ...
     private void initComponents()
     {
          ...
          jktable1.getSelectionModel().addListSelectionListener(new
               ...
               JTJenServ.setmaxtText(25);
               JTJenServ.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N

               JTKet.setmaxtText(50);
                              ...
                              .addGroup(layout.createSequentialGroup()
                                   ...
                                   .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addGroup(layout.createSequentialGroup()
                                             ...
                                             .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                             .addComponent(JTCari, javax.swing.GroupLayout.PREFERRED_SIZE, 121, javax.swing.GroupLayout.PREFERRED_SIZE))
                                        .addGroup(layout.createSequentialGroup()
                                             .addComponent(jLabel2)
                                             .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                             .addComponent(JTNO, javax.swing.GroupLayout.PREFERRED_SIZE, 150, javax.swing.GroupLayout.PREFERRED_SIZE))
                                        .addGroup(layout.createSequentialGroup()
                                             .addComponent(jLabel3)
                                             .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                             .addComponent(JTJenServ, javax.swing.GroupLayout.PREFERRED_SIZE, 150, javax.swing.GroupLayout.PREFERRED_SIZE))
                                        .addGroup(layout.createSequentialGroup()
                                             .addComponent(jLabel4)
                                             .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                             .addComponent(JTKet, javax.swing.GroupLayout.PREFERRED_SIZE, 282, javax.swing.GroupLayout.PREFERRED_SIZE)))
               ...
               layout.setVerticalGroup(
                    ...
                    .addGroup(layout.createSequentialGroup()
                         ...
                         .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                              .addComponent(jLabel3)
                              .addComponent(JTJenServ, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                         .addGap(6, 6, 6)
                         .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                              .addComponent(jLabel4)
               ...
               layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {BHapus, BRefresh, BTambah, BUbah, JTCari, JTJenServ, JTKet, JTNO, jLabel1, jLabel2, jLabel3, jLabel4, jcomFromDBtable1});
    ...
    private void BTambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BTambahActionPerformed
        if (isvalidinput()) {
            ...
            runUpd.seterorm("gagal Tambah " + NamaMaster);
            int no = runUpd.excute();
            if (no != 0) {
                showMessageDialog(this, "Berhasil Tambah Data " + NamaMaster);
                refresh();
                F.History.STambah("Tambah Data " + NamaMaster + " " + JTJenServ.getText());
            }
        }
    ...
    private void BHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BHapusActionPerformed
        if (jackop("Apakah Anda Yakin Mau Menghapus Data " + NamaMaster)) {
            ...
            showMessageDialog(this, "Batal Menghapus Data " + NamaMaster + " " + JTNO.getText());
        }
    ...
    {//GEN-HEADEREND:event_formWindowClosing
        F.VarJFrame.stockKeeper = null;        // TODO add your handling code here:
     ...
     */
     ...
     private F.JackTextField JTJenServ;
