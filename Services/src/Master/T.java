...
public class T extends javax.swing.JFrame {
    ...
    String NamaMaster = "TRUCK";
    String SelecQ = "SELECT `KdTruck` as 'NO', `NoPolisi` as 'Plat', `KMO` as 'KM Oli' ,if(`Stat`=0, 'KM Aktiv','KM Putus' ) as 'Status' FROM `ttruck`";
    String SelecQ2 = "SELECT `KdTruck`, `NoPolisi`, `KMO`,if(`Stat`=0, 'KM Aktiv','KM Putus' ) FROM `ttruck`";
    String QInsert;
    String QUpdate;
    String QDelete;
    String QJcomStatus = "SELECT `VarPar` FROM `tbseting` WHERE `KSet` = 1 order by `NoCol` desc ";

    void GetQinsert() {
        QInsert = "INSERT INTO `ttruck`( `NoPolisi`, `KMO`, `Stat`) VALUES ('" + JTPlat.getText() + "'," + JNKMO.getFloat() + "," + (JCStatus.getSelectedIndex() - 1) + ")";
    }

    void GetQupdate() {
        QUpdate = "UPDATE `ttruck` SET `NoPolisi`='" + JTPlat.getText() + "',`KMO`=" + JNKMO.getFloat() + ",`Stat`= " + (JCStatus.getSelectedIndex() - 1) + " WHERE `KdTruck`= " + JTNO.getText() + "";
    }

    void getQDelete() {
        QDelete = "DELETE FROM `ttruck` WHERE `KdTruck`=" + JTNO.getText() + "";
    }
    ...
    void getSelectedData() {
        if (jktable1.getSelectedRow() != -1) {
            ...
            JNKMO.setFloat(jktable1.getFloat(bar, 2));
            JCStatus.setSelectedItem(jktable1.getValueAt(bar, 3));
        }
    }
    ...
    boolean isvalidinput() {
        if (JTPlat.getText().isEmpty()) {
            JOptionPane.showMessageDialog(this, "No Plat Tidak Boleh Kosong");
            return false;
        } else {
            return true;
        }
     ...
     */
     ...
     private void initComponents()
     {
          ...
          JNKMO = new F.JNumberTextField(7);
          ...
          jktable1.getSelectionModel().addListSelectionListener(new
               ...
               jLabel9.setText("Status Truck");

               JTPlat.setmaxtText(30);
               JTPlat.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N

               JCStatus.setQuery(QJcomStatus);
               JCStatus.excute();
               JCStatus.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N

               JNKMO.setText("0.00");
               JNKMO.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
                              ...
                              .addGroup(layout.createSequentialGroup()
                                   ...
                                   .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        ...
                                        .addGroup(layout.createSequentialGroup()
                                             ...
                                             .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                             .addComponent(JNKMO, javax.swing.GroupLayout.PREFERRED_SIZE, 249, javax.swing.GroupLayout.PREFERRED_SIZE))
                                        .addGroup(layout.createSequentialGroup()
               ...
               layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {jLabel2, jLabel3, jLabel5, jLabel9});
               ...
               layout.setVerticalGroup(
                    ...
                    .addGroup(layout.createSequentialGroup()
                         ...
                         .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                              .addComponent(jLabel5)
                              .addComponent(JNKMO, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                         .addGap(9, 9, 9)
                         .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                              .addComponent(jLabel9)
               ...
               layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {BHapus, BRefresh, BTambah, BUbah, JCStatus, JNKMO, JTCari, JTNO, JTPlat, jLabel1, jLabel2, jLabel3, jLabel5, jLabel9, jcomFromDBtable1});
    ...
    {//GEN-HEADEREND:event_formWindowClosing
     ...
     private F.JNumberTextField JNKMO;
